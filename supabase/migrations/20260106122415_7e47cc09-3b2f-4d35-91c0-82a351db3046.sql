-- Seed the EO3 Info Pack template into platform_email_templates
INSERT INTO public.platform_email_templates (
  ...
  'eo3_info_pack',
  'EO3 Info Pack (Jan 2026)',
  'Elementary Obedience (EO3) class information pack - exact PDF layout match',
  'EO',
  'Elementary Obedience (EO3) Class Information - {{class_dates}}',
  '<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<body style="margin: 0; padding: 0; font-family: Arial, Helvetica, sans-serif; font-size: 13px; line-height: 1.4; color: #333333; background-color: #ffffff;">
  ...
  '[
    {"key": "class_day_time", "label": "Class Day & Time", "type": "text", "placeholder": "e.g., Saturdays 09h00 - 10h00"},
    {"key": "class_dates", "label": "Class Dates", "type": "text", "placeholder": "e.g., 18 Jan - 22 Mar 2026"},
    {"key": "new_enrolment_price", "label": "New Enrolment Price", "type": "text", "placeholder": "e.g., R1 680.00"},
    {"key": "enrolment_fee", "label": "Enrolment Fee", "type": "text", "placeholder": "e.g., R265.00"},
    {"key": "total_price", "label": "Total Price (New)", "type": "text", "placeholder": "e.g., R1 945.00"},
    {"key": "graduate_price", "label": "Graduate Price", "type": "text", "placeholder": "e.g., R1 680.00"},
    {"key": "banking_details", "label": "Banking Details", "type": "textarea", "placeholder": "Bank name, account number, etc."}
  ]'::jsonb,
  true
)

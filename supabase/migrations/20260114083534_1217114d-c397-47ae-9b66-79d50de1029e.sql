-- Insert Payment Receipt template for Delta branch
INSERT INTO public.branch_email_templates (
  branch_id,
  type,
  name,
  subject,
...
<body style="margin: 0; padding: 0; font-family: ''Segoe UI'', Tahoma, Geneva, Verdana, sans-serif; background-color: #f5f5f5;">
  ...
  NULL
WHERE NOT EXISTS (
  SELECT 1 FROM public.branch_email_templates 
  WHERE branch_id = '6351a9e8-77db-403b-ab1f-cd47e393a006' 
  AND type = 'payment_receipt'
);

-- Insert Payment Receipt template for Randburg branch
INSERT INTO public.branch_email_templates (
  branch_id,
  type,
  name,
...
WHERE NOT EXISTS (
  SELECT 1 FROM public.branch_email_templates 
  WHERE branch_id = '284817cf-de0d-43b9-a506-a3efa625ae1c' 
  AND type = 'payment_receipt'
);
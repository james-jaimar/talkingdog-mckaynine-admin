/**
 * Class Confirmation Email Template
 * Sent automatically when an invoice is marked as paid
 */

export const CLASS_CONFIRMATION_TEMPLATE = `
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
export const CLASS_CONFIRMATION_SUBJECT = "🐕 Class Enrollment Confirmed - {{class_name}}";

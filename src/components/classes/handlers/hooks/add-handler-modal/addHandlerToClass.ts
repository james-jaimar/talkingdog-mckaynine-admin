...
export const addHandlerToClass = async ({
  ...
  try {
    ...
    // Note: Randburg Puppy is session-count based (6 sessions, any dates), not date-locked.
    // Attendance/session tracking happens via class_attendance.performance_grade (1-6).

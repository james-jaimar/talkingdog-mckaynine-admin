...
export function createScheduleAction(classId: string, navigate: (path: string) => void) {
  return (
    <Button 
...
export function showClassCreatedToast(className: string, classId: string, navigate: (path: string) => void) {
  toast({
    title: "Class created successfully",
    description: `${className} has been added. Would you like to create a schedule for this class?`,
    action: createScheduleAction(classId, navigate),
